...
# PhoenixReactWebpackBoilerplate.Web.Endpoint.load_from_system_env/1 dynamically.
...
# start per endpoint:
#
#     config :phoenix_react_webpack_boilerplate, PhoenixReactWebpackBoilerplate.Web.Endpoint, server: true
#
